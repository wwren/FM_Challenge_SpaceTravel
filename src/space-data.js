...
const homeText = {
  firstParagraph: "So, you want to travel to",
  highlight: "Space",
  lastParagraph:
...
export const pageTopLeftIntro = {
  destinations: "01_pick your destination",
  crew: "01_meet your crew",
  technology: "03_space launch 101",
};

export const distanceBottomTitle = {
  title1: "avg. distance",
